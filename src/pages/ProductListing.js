...
const ProductListing = () => {
    return (
        ...
        <div className="products-ctn">
            <h3 className="mg-bottom-lg">Showing All Products <small>(showing 6 products)</small></h3>
            <div className="product-grid">
                {/* <!-- boook 1 --> */}
                <div className="card-vertical-ctn">
                    <img className="card-img" src={IMAGES.book1} alt="product-image" />
                    ...
                    <a href="#" className="btn btn-icon-text-outline">Go to cart</a>
                </div>
                {/* <!-- boook 2 --> */}
                <div className="card-vertical-ctn">
                    ...
                    <p className="card-subtitle">by Robert Kiyosaki</p>
                    <div className="card-pricing">
                        <p className="card-price fw-bold">₹240</p>
                        <p className="card-price-cut">₹399</p>
                        <p className="card-price-discount">save ₹159 (40%)</p>
                ...
                {/* <!-- boook 3 --> */}
                <div className="card-vertical-ctn">
                    <img className="card-img" src={IMAGES.book3} alt="product-image" />
                    <div className="card-title">
                ...
                {/* <!-- boook 4 --> */}
                <div className="card-vertical-ctn">
                    <img className="card-img" src={IMAGES.book4} alt="product-image" />
                    <div className="card-title">
                ...
                {/* <!-- boook 5 --> */}
                <div className="card-vertical-ctn">
                    <img className="card-img" src={IMAGES.book5} alt="product-image" />
                    <div className="card-title">
                ...
                {/* <!-- book 6 --> */}
                <div className="card-vertical-ctn">
                    <img className="card-img" src={IMAGES.book6} alt="product-image" />
                    <div className="card-title">
    ...
    {/* <!-- Filter floating btn --> */}
    <button className="btn-float-action filter-cta"><span className="material-icons">filter_alt</span></button>
        </>
    );
}
